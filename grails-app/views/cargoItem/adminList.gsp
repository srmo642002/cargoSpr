...
<div id="list-cargoItem" ng-controller="cargoItemController" class="content scaffold-list" role="main">
    ...
    <br>
    <rg:grid domainClass="${cargo.cargoItem.CargoItem}" caption="" columns="[[name:'id',formatter:'generateCheckbox'],[name:'item'],[name:'nonContainerized',formatter: 'checkbox'],[name:'containerized',formatter: 'checkbox'],[name:'containerNo'],[name:'size'],[name:'type'],[name:'commodity'],[name:'typeOfPackage'],[name:'noOfPackage'],[name:'grade'],[name:'grossWeight'],[name:'totalWeight'],[name:'volume'],[name:'dg',formatter: 'checkbox'],[name:'incoClass'],[name:'unNo',formatter: 'integer']]">">
    </rg:grid>
    ...
    <g:javascript>
        ...
        $("[name$=nonContainerized]").change(function(){
            if ($("[name$=nonContainerized]").is(":checked")){
